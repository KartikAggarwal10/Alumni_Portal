        ...
        <section className={styles.dashboardSection}>
            ...
            <div className={styles.dashboardStats} id="dashboardStats">
                <div className={styles.statItem} style={{ "--index": 0 }}>
                    <img src={`${import.meta.env.VITE_API_URL}/people/photo1.jpg`} alt="Members Icon" />
                ...
                <div className={styles.statItem} style={{ "--index": 1 }}>
                    <img src={`${import.meta.env.VITE_API_URL}/people/company.jpeg`} alt="Companies Icon" />
                ...
                <div className={styles.statItem} style={{ "--index": 2 }}>
                    <img src={`${import.meta.env.VITE_API_URL}/people/achievementicon.jpg`} alt="Achievements Icon" />
                ...
                <div className={styles.statItem} style={{ "--index": 3 }}>
                    <img src={`${import.meta.env.VITE_API_URL}/people/country.jpeg`} alt="Countries Icon" />
