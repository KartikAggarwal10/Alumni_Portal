...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const handleMenuClick = () => navLinks?.classList.toggle("active");
        ...
        // Small delay to ensure DOM is ready for orb animation
        ...
        <div className="home-page-container">
            ...
            <section className="updates-section section">
                ...
                <div className="updates" id="recentUpdates">
                    {/* Dynamic updates loaded via API - EXACTLY 3 cards */}
                </div>
            </section>
